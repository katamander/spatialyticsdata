...
## Get data
```{r}
baths_hist <- readRDS("../../cds-spatial/data/baths_hist.rds") # historical baths
baths_cph <- readRDS("../../cds-spatial/data/baths_cph.rds")  # baths by suburb centroids 
baths_osm <- readRDS("../../cds-spatial/data/baths_osm.rds") # OSM baths
```
